/datum/job
	...
	//Job access. The use of minimal_access or access is determined by a config setting: game_options.jobs_have_minimal_access
...
/datum/job/proc/get_access()
	...
	if(game_options.jobs_have_minimal_access)
		. = src.minimal_access.Copy()
	else
		. = src.access.Copy()

	if(game_options.everyone_has_maint_access) //Config has global maint access set
