...
*/
	...
	//Player Notes
		...
		for(var/mode in gamemode_config.modes)
			dat += {"<A href='?src=\ref[src];c_mode2=[mode]'>[gamemode_config.mode_names[mode]]</A><br>"}
		...
		for(var/mode in gamemode_config.modes)
			dat += {"<A href='?src=\ref[src];f_secret2=[mode]'>[gamemode_config.mode_names[mode]]</A><br>"}
